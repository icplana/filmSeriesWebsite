      ...
      <div className="mb-10 mt-3 mx-3">
        {
            ...
            <>        
                ...
                <form onSubmit={ onSubmit } className="mb-3 mx-5 text-primary">
                    ...
                    <p className="text-center italic text-md mx-1 text-primaryWhite"><span className="text-xl ">*</span>Each comic, character, creator, event, serie or story has a unic numeric ID, you can get it searching them in search section or looking for it in all section (not recomended since there are too many results). We strongly recomend you to use favorites to make it easier to save the IDs of your favorite content.</p>    
                </form>
