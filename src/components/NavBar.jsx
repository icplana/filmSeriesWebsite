...
export const NavBar = () => {
  ...
  return (
    <header className="bg-gradient-to-b from-primary to-primaryWhite border min-w-screen">

      <div className="max-w-screen-xl mx-auto flex justify-evenly md:px-5 py-4">
        <div className="mr-auto">
          <MobileNavbar />
        </div>

        <div className="hidden sm:flex w-full justify-evenly lg:text-lg py-4">
...

          {
            ...
            :
              <div onClick={ showLoginCard } className="cursor-pointer" >
                <p>Login</p>
                <div className="hidden absolute bg-white w-96 right-5 rounded-md 2xl:scale-125 2xl:top-36 2xl:right-28" ref={ loginCard }>
